...
#' @param k facteur multiplacteur e = k * sigma pour la 2ème enveloppe, par defaut k = 2,54 c'est à dire 99 % de confiance
...
#' - une première à ±1 sigma (semi-transparente)
#' - une seconde plus large à ±2.54 sigma (intervalle large)
#'
