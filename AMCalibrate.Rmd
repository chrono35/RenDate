...
#devtools::install_github("chrono35/RenDate.R", force = TRUE)
#library("RenDate.R", lib.loc="/Library/Frameworks/R.framework/Versions/3.5/Resources/library")
```
